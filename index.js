...
const COHORT = "/2602-charles"; // Make sure to change this!
...
/** Deletes the selected party via the API */
...
function NewPartyForm() {
  ...
  $form.addEventListener("submit", async (event) => {
    ...
    const isoDate = new Date($form.date.value).toISOString();
    const party = {
